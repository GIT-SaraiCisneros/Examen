...
nota_final = 0.4*nota_matematica + 0.3*nota_ciencia + 0.3*nota_historia

print('\n*** RESULTADO PREGUNTA 02 ***\n')
print ("La nota final es: ", f'{nota_final:.1f}')
...
if nota_final >= 13.0:
    ...
    print("El estudiante obtuvo una nota final de {} y su estado final es: Desaprobado".format(nota_final))